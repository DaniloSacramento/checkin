...
class _CheckinPageState extends State<CheckinPage> {
 ...
 // }
  ...
  String calcularDiferencaHorasMinutos(String? dtChegada, String? dtEntrada) {
    if (dtChegada != null) {
      DateTime chegada = DateTime.parse(dtChegada);
      DateTime entrada = dtEntrada != null ? DateTime.parse(dtEntrada) : DateTime.now();
      Duration diff = entrada.difference(chegada);
      int horas = diff.inHours;
      int minutos = diff.inMinutes.remainder(60);
      if (horas == 0) {
      ...
      return 'Data de chegada inválida';
    }
  }
